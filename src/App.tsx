        ...
        <AppHeader>
          ...
          <div className="max-w-6xl mx-auto mt-10 px-4 text-center">
            ...
            <div className="space-x-4 mb-10">
              <Link to="/lab1"><Button>Lab 1</Button></Link>
              <Link to="/lab2"><Button>Lab 2</Button></Link>
              <Link to="/lab3"><Button>Lab 3</Button></Link>
              <Link to="/lab4"><Button>Lab 4</Button></Link>
              <Link to="/lab5"><Button>Lab 5</Button></Link>
              <Link to="/lab6"><Button>Lab 6</Button></Link> 
            </div>
